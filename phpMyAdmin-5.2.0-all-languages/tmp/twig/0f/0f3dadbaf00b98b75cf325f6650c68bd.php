...
class __TwigTemplate_f4ae80c7dce467d0b7ec9c7c10f3d333 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "D:\\WAD-2022-dec\\phpMyAdmin-5.2.0-all-languages\\templates\\database\\export\\index.twig");
    }
}
